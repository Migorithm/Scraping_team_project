    ...
    def get_range(third_input):
        ...
        while 1:
            ...
            try :
                ...
                if m1 == '2' and d1 in ('29','30','31'):
                    d1 = '28'
                if m2 == '2' and d2 in ('29','30','31'):
                    d2 = '28'
                if (m1 in '469' or m1 =='11') and d1 =='31':
                    d1 ='30'
                if (m2 in '469' or m2 == '11') and d2 == '31':
                    d2 = '30'
                from_ =(y1,m1,d1)
                to_ = (y2,m2,d2)
...
if __name__ == '__main__':
    ...
    Nav_scrap.img_or_txt(search)




#검색어
#현재 검색어에 대한 DB결과(인서트기존에 된 IMG나, 코멘트 자료가 있는지 보기 위해서)
#부족하다면 해당 검색어에 대한 추가적인 스크래핑을 시작한다.
